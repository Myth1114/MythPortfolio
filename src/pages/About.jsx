      ...
      <div className="container">
        ...
        <section className="about-page__intro">
          ...
          <div className="about-page__intro-content">
            ...
            <p>
              I started my professional journey in frontend development, working
              with JavaScript, React and modern web technologies. Over time, my
              responsibilities expanded beyond development into technology
              management, digital presence, social media and marketing strategy.
            </p>
