    ...
    <main className="work-page">
      <div className="container">
        ...
        <section className="work-page__intro">
          <p>
            Different projects, different problems. From ecommerce applications
            and corporate websites to education platforms, most of my work has
            been about turning ideas into interfaces that are useful, responsive
